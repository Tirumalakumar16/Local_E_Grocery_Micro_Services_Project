...
public class ShopController {
    ...
    @GetMapping("/shops")
    public List<ResponseShopDto> getAll(@RequestHeader("LoggedInUser") String userName) throws UserNotAutherizedException {

            return shopService.getAll(userName);
    }

    @GetMapping("/shop/{city}")
    public List<ResponseShopCustDto> getByCity(@PathVariable("city") String city) {
